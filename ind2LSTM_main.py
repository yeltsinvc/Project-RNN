...
data_ind=data_ind[data_ind['width'] >=0.2]##delete all pedestrian
...
directory = r'C:\Users\valero\Documents\Yeltsin 2.0\Project-RNN\Data_LSTM_CF'

number_of_files = len([item for item in os.listdir(directory) if os.path.isfile(os.path.join(directory, item))])


data_ngsim.to_csv('Data_LSTM_CF/data_LSTM_CF_LC'+str(number_of_files+1)+'.csv')
